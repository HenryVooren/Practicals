...
def repeat_string(s, n):
    ...
    # return s * n
    """The original function did not print with spaces in between each string?!"""
    repeated_string = ""
    for i in range(0, n):
        repeated_string = repeated_string+s
...
def phrase_format(phrase):
    ...
    >>> phrase_format('hello')
    'Hello.'
    >>> phrase_format('It is an ex parrot.')
    'It is an ex parrot.'
    >>> phrase_format('Im off to see the wizard')
