...
# use a list comprehension to create a list of integers from the list of strings
...
NUMBER_THRESHOLD = 9
numbers_greater_than = [number for number in numbers if number > NUMBER_THRESHOLD]
